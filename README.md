...
Here is the official implementation of the model `MCC-DA` in paper ["Multi-source Collaborative Contrastive Learning for Decentralized Domain Adaptation", IEEE TCSVT](https://ieeexplore.ieee.org/document/9940295).
